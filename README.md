...
<!-- Animated Banner -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/keploy/keploy/main/pkg/assets/keploy-logo-dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/keploy/keploy/main/pkg/assets/keploy-logo-light.svg">
  <img alt="Keploy Logo" src="https://raw.githubusercontent.com/keploy/keploy/main/pkg/assets/keploy-logo-light.svg" width="60%">
</picture>

<h2>⚡️ API Tests Faster Than Unit Tests, From User Traffic ⚡️</h2>
...
<!-- Animated GIF Demo -->
<img src="https://raw.githubusercontent.com/keploy/keploy/main/.github/assets/demo.gif" alt="Keploy Demo" width="80%">
...
**Java**
```bash
keploy record -c "java -jar app.jar"
```
...
| ⏱️ **Time Freezing** | Deterministic test replay by freezing system time |
| 📚 **Mock Registry** | Centralized registry to manage, reuse, and version mocks |
...
*Mention your availability in the email — we'll send a calendar invite right away!*
...
Read our [📜 Contribution Guidelines](CONTRIBUTING.md) and [❤️ Code of Conduct](CODE_OF_CONDUCT.md) before contributing.
...
<a href="https://landscape.cncf.io/?selected=keploy">
  <img src="https://raw.githubusercontent.com/cncf/artwork/master/other/cncf-landscape/horizontal/color/cncf-landscape-horizontal-color.svg" width="200px">
</a>
...
<a href="https://star-history.com/#keploy/keploy&Date">
  <picture>
    ...
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=keploy/keploy&type=Date" />
  </picture>
</a>
